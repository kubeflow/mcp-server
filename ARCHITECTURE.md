...
| Spark tools (5) — SparkConnect sessions | `spark/api/` | ✅ Available |
...
| Spark Connect (session lifecycle) | `spark/` | ✅ Available ([#5](https://github.com/kubeflow/mcp-server/issues/5)) |
